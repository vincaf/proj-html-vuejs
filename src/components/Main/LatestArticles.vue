<template>
  <section>
    <div class="container">
        <div class="row py-5">
            <div class="col-9">
                <SingleLatestArticle v-for="article in articles" :key="article.id"
                :title="article.title"
                :imgUrl="article.img" />
            ...
            <div class="col-3">
                <div class="social">
                    ...
                    <div id="tags">
                        <div class="title py-3">TAGS</div>
                        <div class="d-flex justify-content-between">
                            <span class="tags">DESIGN</span>
                            <span class="tags">BRANDS</span>
                    ...
                    <div id="facebook">
                        <div class="title mb-2">FIND US ON FACEBOOK</div>
                        <span class="link-facebook">Okler Themes</span>
                    </div>
...
<script>
import SingleLatestArticle from './SingleLatestArticle.vue';
